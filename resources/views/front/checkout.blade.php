                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <div class="single-form form-default">
                                                    ...
                                                    <div class="form-input form">
                                                        <x-form.input name='addr[billing][email]' placeholder="Email"/>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                            ...
                                            <div class="col-md-6">
                                                <div class="single-form form-default">
                                                    <label>Country</label>
                                                    <div class="form-input form">
                                                        <select name='addr[billing][country]' class="form-control form-select" id="country">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <div class="single-form form-default">
                                                    <label>Email Address</label>
                                                    <div class="form-input form">
                                                        <x-form.input name='addr[shipping][email]' placeholder="Email"/>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                            ...
                                            <div class="col-md-6">
                                                <div class="single-form form-default">
                                                    <label>Country</label>
                                                    <div class="form-input form">
                                                        <select name='addr[shipping][country]' class="form-control form-select" id="country">
                                                            <option value="">Primary Country</option>
                                                            @foreach ($countries as $countryCode => $countryName)
                                                                <option value="{{ $countryCode }}">
                                                                    {{ $countryName }}
                        ...
                        <div class="checkout-sidebar">
                            ...
                            <div class="checkout-sidebar-banner mt-30">
                                <a href="product-grids.html">
                                    <img src="{{ asset('assets/images/banner/banner.png') }}" alt="#">
                                </a>
                            </div>
                        </div>
                    </div>
