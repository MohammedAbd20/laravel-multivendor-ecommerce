                        ...
                        <form class="card login-form" action="{{ route('login') }}" method="post">
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group input-group">
                                    ...
                                    <input class="form-control" type="email" id="reg-email" name="{{ config('fortify.username') }}">
                                </div>
                                <div class="form-group input-group">
                                ...
                                <div class="d-flex flex-wrap justify-content-between bottom-content">
                                    <div class="form-check">
                                        <input type="checkbox" class="form-check-input width-auto" id="exampleCheck1" name="rememper" value="1">
